...
/**
 * 
 * This service processes VMS DATEX II v2 messages (D2LogicalModel). The
 * payloads are inserted into the MatrixSignalStatic and VMSStatic data stores.
 * 
...
public class DATEXIINTISModelVMSProcessService extends DATEXIIProcessService {
	...
	@Autowired
	public DATEXIINTISModelVMSProcessService(VMSStaticDataStore vmsStaticDataStore,
	...
	private void processVmsUnitRecord(VmsUnitRecord vmsUnitRecord, Date publicationTime, String vmsUnitTableId) {
		...
		case "NTIS_Matrix_Units":
			MatrixSignalStaticData matrixSignalStaticData = new MatrixSignalStaticData(vmsUnitIdentifier,
					publicationTime, vmsUnitRecord);
