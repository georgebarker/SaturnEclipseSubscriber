...
/**
 * 
 * This service retrieves the latest network model and forwards it to the DATEX
 * II Update Service for processing.
 * 
...
public class DATEXIINetworkModelUpdateService {
	...
	private void fetchNetworkModel(String urlString, String username, String password) {
