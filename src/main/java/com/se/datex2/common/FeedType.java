...
public enum FeedType {
	...
	ANPR("ANPR Journey Time Data"), MIDAS("MIDAS Loop Traffic Data"), TMU("TMU Loop Traffic Data"), FUSED_SENSOR_ONLY(
			"Fused Sensor-only PTD"), FUSED_FVD_AND_SENSOR_PTD("Fused FVD and Sensor PTD"), VMS(
					"VMS and Matrix Signal Status Data"), NTIS_MODEL_UPDATE_NOTIFICATION(
							"NTIS Model Update Notification"), EVENT("Event Data"), TAME(
									"TAME Loop Traffic Data"), NTIS_MODEL_VMS_TABLES(
											"NTIS Model - VMS Tables"), NTIS_MODEL_PREDEFINED_LOCATIONS(
													"NTIS Model - Predefined Locations"), NTIS_MODEL_MEASUREMENT_SITES(
															"NTIS Model - Measurement Sites");
