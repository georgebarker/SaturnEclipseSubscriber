...
public class DATEXIIModelUpdateNotificationProcessService extends DATEXIIProcessService {
	...
	public Boolean getLoadNwkModelOnStartup() {
		return loadNwkModelOnStartup;
	}

	public void setLoadNwkModelOnStartup(Boolean loadNwkModelOnStartup) {
		this.loadNwkModelOnStartup = loadNwkModelOnStartup;
	}
